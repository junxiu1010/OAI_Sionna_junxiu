...
typedef struct {
  ...
  // MU-MIMO extension
  uint8_t mu_mimo_secondary;  // 1 if secondary UE in MU-MIMO pair (PHY uses ADD mode)
  int16_t mu_mimo_alpha_q15;  // power scaling factor in Q15 (32767 = 1.0, 23170 = 1/sqrt(2))
