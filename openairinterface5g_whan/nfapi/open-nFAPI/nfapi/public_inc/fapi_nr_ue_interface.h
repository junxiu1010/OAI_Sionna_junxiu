...
#define FAPI_NR_TYPE2_MAX_BEAMS 4
#define FAPI_NR_TYPE2_MAX_LAYERS 2
#define FAPI_NR_TYPE2_MAX_SUBBANDS 19
...
typedef struct {
  ...
  bool is_type2;
  uint8_t num_beams;          // L
  uint8_t port_sel_d;         // d
  uint8_t port_selection_indicator;
  uint8_t strongest_coeff_indicator[FAPI_NR_TYPE2_MAX_LAYERS];
  uint8_t wideband_amplitude[2 * FAPI_NR_TYPE2_MAX_BEAMS][FAPI_NR_TYPE2_MAX_LAYERS];
  uint8_t subband_phase[FAPI_NR_TYPE2_MAX_SUBBANDS][2 * FAPI_NR_TYPE2_MAX_BEAMS][FAPI_NR_TYPE2_MAX_LAYERS];
  uint8_t subband_amp[FAPI_NR_TYPE2_MAX_SUBBANDS][2 * FAPI_NR_TYPE2_MAX_BEAMS][FAPI_NR_TYPE2_MAX_LAYERS];
...
typedef struct {
  ...
  // Type-II Port Selection configuration (set by MAC from RRC CodebookConfig)
  bool type2_port_selection;
  uint8_t type2_num_beams;          // L: 2, 3, or 4
  uint8_t type2_port_sel_d;         // d: 1, 2, 3, or 4
  uint8_t type2_phase_alphabet;     // 4 or 8
  bool type2_subband_amplitude;
