...
#define CONFIG_STRING_MACRLC_MU_MIMO                       "mu_mimo"
#define CONFIG_STRING_MACRLC_FORCE_MU_DL_TRAFFIC           "force_mu_dl_traffic"
...
#define HLP_MACRLC_MU_MIMO "Enable MU-MIMO downlink scheduling (2TX, 2UE x 1RX)"
#define HLP_MACRLC_FORCE_MU_DL_TRAFFIC "Inject dummy DL bytes for MU-MIMO testing when no real traffic"
...
#define MACRLCPARAMS_DESC { \
  ...
  {CONFIG_STRING_MACRLC_MU_MIMO,                     HLP_MACRLC_MU_MIMO,       PARAMFLAG_BOOL, .u8ptr=NULL, .defintval=0,   TYPE_UINT8,   0}, \
...
#define MACRLC_MU_MIMO_IDX                                     33
#define MACRLC_LOCAL_N_ADDRESS_F1U_IDX                         34
#define MACRLC_TRANSPORT_S_SHM_PREFIX                          35
#define MACRLC_TRANSPORT_S_POLL_CORE                           36
#define MACRLC_ANALOG_BEAMFORMING_IDX                          37
#define MACRLC_ANALOG_BEAM_DURATION_IDX                        38
#define MACRLC_ANALOG_BEAMS_PERIOD_IDX                         39
