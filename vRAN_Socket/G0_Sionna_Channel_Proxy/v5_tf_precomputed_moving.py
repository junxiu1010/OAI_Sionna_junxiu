"""
================================================================================
v5_tf_precomputed_moving.py - TensorFlow + 사전 계산 채널 + 이동 RX 시뮬레이션
...
[핵심 특징]
- GPU: TensorFlow
- 채널: 사전 계산된 .npy 파일 (이동 RX 시나리오)
- 특징: 시간에 따라 변하는 채널 인덱스 사용
...
UE_km_h = 30
file_name = f"h_delay_3.5_GHz_{UE_km_h}km_h.npy"
