...
#
# 로그 파일:
#   ~/oai_sionna_junxiu/logs/YYYYMMDD_HHMMSS_G1B_v0_ipc_1ue/
#   ~/oai_sionna_junxiu/logs/latest → 최근 실행 심링크
#
# 종료:
...
docker exec -i $PROXY_ENV_ARGS oai_sionna_proxy python3 -u \
    "/workspace/vRAN_Socket/G1B_SingleUE_MIMO_Channel_Proxy/${PROXY_SCRIPT}" \
